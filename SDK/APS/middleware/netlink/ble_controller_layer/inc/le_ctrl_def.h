...
//	0xFF.11 Vendor-Specific Notify Control PDU Command
typedef struct {
	uint16_t Connection_Handle;
...
//	0xFF.12 Vendor-Specific Decrypt Fail Command
typedef struct {
	uint16_t Connection_Handle;
...
//	0xFF.10 Vendor-Specific Start Encryption Event
typedef struct {
	uint8_t Subevent_Code;
	uint16_t Connection_Handle;
...
//	0xFF.11 Vendor-Specific Send Control PDU Event
typedef struct {
	uint8_t Subevent_Code;
	uint16_t Connection_Handle;
...
//	0xFF.12 Vendor-Specific Number of Completed Bytes Event
typedef struct {
	uint8_t Subevent_Code;
	uint16_t Connection_Handle;
