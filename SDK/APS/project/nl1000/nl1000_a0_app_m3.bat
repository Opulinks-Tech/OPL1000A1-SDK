...
@REM #2 [!L] = .\Output\Objects\nl1000_a0_app_m3.axf
@REM #3 [@L] = nl1000_a0_app_m3
...
@COPY Output\Objects\nl1000_a0_app_m3.bin %PATCH_FOLDER% /Y > NUL
