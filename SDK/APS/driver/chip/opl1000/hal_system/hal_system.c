...
/* Pin-Mux relative*/
RET_DATA T_Hal_SysPinMuxBootROMPreInit   Hal_SysPinMuxBootROMPreInit;
...
RET_DATA T_Hal_SysPinMuxSpiFlashQuadInit Hal_SysPinMuxSpiFlashQuadInit;
...
/*************************************************************************
* FUNCTION:
*  Hal_SysPinMuxBootROMPreInit
*
* DESCRIPTION:
*   1. Pin-Mux pre-initial for BootROM
...
*
*************************************************************************/
void Hal_SysPinMuxBootROMPreInit_impl(void)
{
    volatile uint32_t tmp;
...
*
* DESCRIPTION:
*   1. Pin-Mux initial for SPI flash quad mode
*   2. Related reg.: AOS 0x090 ~ 0x0DC
* CALLS
*
* PARAMETERS
...
*
*************************************************************************/
void Hal_SysPinMuxSpiFlashQuadInit_impl(void)
{
    volatile uint32_t tmp;
...
void Hal_Sys_Pre_Init(void)
{
    ...
    /* Pin-Mux relative*/
    Hal_SysPinMuxBootROMPreInit   = Hal_SysPinMuxBootROMPreInit_impl;
    ...
    Hal_SysPinMuxSpiFlashQuadInit = Hal_SysPinMuxSpiFlashQuadInit_impl;
