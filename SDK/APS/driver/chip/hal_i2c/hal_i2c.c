...
/* Internal */
T_Hal_I2c_Eanble                 _Hal_I2c_Eanble;
T_Hal_I2c_WaitForMasterCompleted _Hal_I2c_WaitForMasterCompleted;

T_Hal_I2c_SpeedGet Hal_I2c_SpeedGet;
T_Hal_I2c_SpeedSet Hal_I2c_SpeedSet;

/* Master mode relative */
T_Hal_I2c_TargetAddrSet Hal_I2c_TargetAddrSet;
T_Hal_I2c_MasterReceive Hal_I2c_MasterReceive;
T_Hal_I2c_MasterTrasmit Hal_I2c_MasterTrasmit;
T_Hal_I2c_MasterInit    Hal_I2c_MasterInit;

/* Slave mode relative */
T_Hal_I2c_SlaveReceive Hal_I2c_SlaveReceive;
T_Hal_I2c_SlaveTrasmit Hal_I2c_SlaveTrasmit;
T_Hal_I2c_SlaveInit    Hal_I2c_SlaveInit;
...
uint32_t _Hal_I2c_Eanble_impl(uint8_t u8Enable)
{
    ...
    if(u8Enable)
    {
        ...
        {
            if(u32Count>I2C_DISABLE_TIMEOUT_TICK)
                return 1;
        }
    }
    return 0;
...
uint32_t Hal_I2c_SpeedSet_impl(E_I2cSpeed_t eSpeed)
{
    ...
    switch(eSpeed)
    {
        case I2C_SPEED_STANDARD:
            ...
            I2C->SS_SCL_HCNT = I2C_STD_SCL_HIGH_MIN * SYSYEM_TICK_PER_MS / MS_TO_NS;
            I2C->SS_SCL_LCNT = I2C_STD_SCL_LOW_MIN * SYSYEM_TICK_PER_MS / MS_TO_NS;
            I2C->FS_SPKLEN = I2C_FS_SPIKE_MAX * SYSYEM_TICK_PER_MS / MS_TO_NS;
            break;
        case I2C_SPEED_FAST:
            I2C->CON = u32Temp | I2C_CON_SPEED_FAST;
            I2C->FS_SCL_HCNT = I2C_FS_SCL_HIGH_MIN * SYSYEM_TICK_PER_MS / MS_TO_NS;
            I2C->FS_SCL_LCNT = I2C_FS_SPIKE_MAX * SYSYEM_TICK_PER_MS / MS_TO_NS;
            break;
        //case I2C_SPEED_HIGH:
        default:
            if( u32EnStatus & I2C_ENABLE_EN )
...
uint32_t Hal_I2c_MasterInit_impl(E_I2cAddrMode_t eAddrMode, E_I2cSpeed_t eSpeed)
{
    ...
    {
        // 10-Bit Master
        I2C->TAR = I2C_CON_MASTER_10BIT;
    }else{
        // 7-Bit Master
        I2C->TAR = I2C_CON_MASTER_07BIT;
    }
