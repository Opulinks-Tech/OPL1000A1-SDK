...
static uint32_t gLeHostNvmStore0[MW_FIM_LE_STORE0_NUM];
static uint32_t gLeHostNvmStore1[MW_FIM_LE_STORE1_NUM];
static uint32_t gLeHostNvmStore2[MW_FIM_LE_STORE2_NUM];
static uint32_t gLeHostNvmStore3[MW_FIM_LE_STORE3_NUM];
