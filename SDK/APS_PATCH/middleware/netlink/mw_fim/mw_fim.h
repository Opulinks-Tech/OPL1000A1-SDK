...
extern void MwFim_Init(void);
extern uint8_t MwFim_FileRead(uint32_t ulFileId, uint16_t uwRecIdx, uint16_t uwFileSize, uint8_t *pubFileData);
extern uint8_t MwFim_FileWrite(uint32_t ulFileId, uint16_t uwRecIdx, uint16_t uwFileSize, uint8_t *pubFileData);
extern uint8_t MwFim_FileWriteDefault(uint32_t ulFileId, uint16_t uwRecIdx);
extern uint8_t MwFim_FileDelete(uint32_t ulFileId, uint16_t uwRecIdx);

extern uint8_t MwFim_ZoneInfoUpdate(uint32_t ulZoneIdx, T_MwFimZoneInfo *ptZoneInfo);
extern uint8_t MwFim_GroupInfoUpdate(uint32_t ulZoneIdx, uint32_t ulGroupIdx, T_MwFimFileInfo *ptGroupInfo);
extern uint8_t MwFim_GroupVersionUpdate(uint32_t ulZoneIdx, uint32_t ulGroupIdx, uint8_t ubVersion);
