...
uint32_t g_ulaMwFimAddrBufferTestA[MW_FIM_TEST_A_NUM];
...
uint32_t g_ulaMwFimAddrBufferTestB[MW_FIM_TEST_B_NUM];

// the address buffer of test C
uint32_t g_ulaMwFimAddrBufferTestC[MW_FIM_TEST_C_NUM];
