...
{
    //uart0_tx :IO2/IO6/IO10/IO20
    {{2,2,3},{6,6,4},{10,10,3},{20,20,0}},
    //uart0_rx :IO3/IO7/IO11/IO21
    {{3,1,0},{7,1,1},{11,1,2},{21,1,5}},
    //uart0_cts :IO8/IO18
    {{8,0,1},{18,0,2}},
    //uart0_rts :IO9/IO19
    {{9,9,3},{19,19,3}},

    //uart1_tx :IO4/IO8/IO11/IO18/IO21/IO22
    {{4,4,3},{8,8,4},{11,11,4},{18,18,0},{21,21,4},{22,22,3}},
    //uart1_rx :IO5/IO9/IO10/IO19/IO20/IO23
    {{5,3,1},{9,3,2},{10,3,3},{19,3,6},{20,3,7},{23,3,8}},
    //uart1_cts :7/IO20
    {{7,2,0},{20,2,2}},
    //uart1_rts :IO6/IO21
    {{6,6,3},{21,21,3}},
    ...
    {{3,3,2},{4,4,2},{6,6,2},{9,9,2},{10,10,2},{19,19,2},{20,20,2},{23,23,2}},
    //i2c_scl_in :IO3/IO4/IO6/Io9/IO10/IO19/IO20/IO23
    {{3,6,1},{4,6,2},{6,6,3},{9,6,4},{10,6,5},{19,6,9},{20,6,10},{23,6,11}},
    //i2c_sda_out :IO2/IO5/IO7/IO8/IO11/IO18/IO21/IO22
    {{2,2,2},{5,5,2},{7,7,2},{8,8,2},{11,11,2},{18,18,2},{21,21,2},{22,22,2}}, 
    //i2c_sda_in IO2/IO5/IO7/IO8/IO11/IO18/IO21/IO22
    {{2,7,1},{5,7,2},{7,7,3},{8,7,4},{11,7,5},{18,7,9},{21,7,10},{22,7,11}},
