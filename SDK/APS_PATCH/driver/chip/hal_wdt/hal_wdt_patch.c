...
* 
*************************************************************************/
void Hal_Wdt_Init_patch(uint32_t u32Ticks)
{
    // Enable module
    Hal_Sys_ApsClkEn(1, APS_CLK_WDT);
    // Reset module
    Hal_Sys_ApsModuleRst(ASP_RST_WDT);
...
* 
*************************************************************************/
void Hal_Wdt_InitForInt_patch(uint32_t u32Ticks)
{
    // Enable module
    Hal_Sys_ApsClkEn(1, APS_CLK_WDT);
    // Reset module
...
* 
*************************************************************************/
void Hal_Wdt_Feed_patch(uint32_t u32Ticks)
{
    WATCHDOG->LOCK = WDT_UNLOCK_KEY;
    WATCHDOG->LOAD = u32Ticks;
    WATCHDOG->LOCK = WDT_LOCK_KEY;
