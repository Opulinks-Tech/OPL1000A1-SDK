...
*  Project:
*  --------
*  NL1000 Project - the Temperature Sensor definition file
*
*  Description:
*  ------------
...
extern uint8_t Hal_Tmpr_CompareResistor(float fResistor, float *pfTemperature);
extern void Hal_Tmpr_CmdParse(char *sCmd);
